              ...
              """),_display_(/*58.16*/for(obj <- results.get(key) ) yield /*58.45*/{_display_(Seq[Any](format.raw/*58.46*/("""
                ...
                <td style="border: 1px solid rgb(104, 207, 164);">
                  """),_display_(/*63.20*/for(topic <- obj.returnTopics()) yield /*63.52*/{_display_(Seq[Any](format.raw/*63.53*/("""
                   """),format.raw/*64.20*/("""<div style="display: inline-block;background-color: #0b7e5b;color: #dee2e1; border-radius:6px; padding: 3px; margin-right: 3px; margin-top: 3px;margin-bottom: 3px;"><a href="/topic/"""),_display_(/*64.202*/topic),format.raw/*64.207*/(""""> """),_display_(/*64.211*/topic),format.raw/*64.216*/("""</a> </div> 
                  """)))}),format.raw/*65.20*/("""
                """),format.raw/*66.17*/("""</td>
              </tr>
              """)))}),format.raw/*68.16*/("""
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: 1687896ea4460de71f9772d0613a9588f17e0382
                  MATRIX: 961->1|1134->79|1164->83|2395->1288|2426->1310|2466->1312|2497->1316|2564->1356|2577->1360|2605->1367|2634->1368|2690->1398|2722->1414|2761->1415|2796->1423|3109->1709|3133->1712|3843->2395|3888->2424|3927->2425|3973->2443|4107->2550|4119->2553|4150->2563|4267->2653|4279->2656|4309->2665|4434->2763|4482->2795|4521->2796|4570->2817|4780->2999|4807->3004|4839->3008|4866->3013|4930->3046|4976->3064|5050->3107|5123->3152|5237->3235|5260->3241|5272->3246|5310->3247|5341->3251|5397->3277|5430->3283
